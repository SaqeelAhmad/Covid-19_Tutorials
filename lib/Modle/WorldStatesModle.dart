/// updated : 1661571179367
/// cases : 605098736
/// todayCases : 312128
/// deaths : 6485974
/// todayDeaths : 576
/// recovered : 579999471
/// todayRecovered : 411577
/// active : 18613291
/// critical : 43489
/// casesPerOneMillion : 77629
/// deathsPerOneMillion : 832.1
/// tests : 6640940624
/// testsPerOneMillion : 872425.87
/// population : 7612040047
/// oneCasePerPeople : 0
/// oneDeathPerPeople : 0
/// oneTestPerPeople : 0
/// activePerOneMillion : 2445.24
/// recoveredPerOneMillion : 76195.01
/// criticalPerOneMillion : 5.71
/// affectedCountries : 230

class WorldStatesModle {
  WorldStatesModle({
      num? updated, 
      num? cases, 
      num? todayCases, 
  ...
  WorldStatesModle.fromJson(dynamic json) {
...
WorldStatesModle copyWith({  num? updated,
  num? cases,
  num? todayCases,
  num? deaths,
  num? todayDeaths,
  ...
  num? criticalPerOneMillion,
  num? affectedCountries,
}) => WorldStatesModle(  updated: updated ?? _updated,
  cases: cases ?? _cases,
